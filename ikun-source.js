...
// 服务端地址
const API_URL = "http://110.41.172.118:9763"
// 服务端配置的请求key
const API_KEY = `hellolxmusicqwq`
// 音质配置(key为音源名称,不要乱填.如果你账号为VIP可以填写到hires)
// 全部的支持值: ['128k', '320k', 'flac', 'flac24bit']
const MUSIC_QUALITY = JSON.parse('{"kw":["128k","320k","flac"],"kg":["128k","320k","flac","flac24bit"],"tx":["128k","320k","flac","flac24bit"],"wy":["128k","320k"],"mg":["128k","320k"]}')
